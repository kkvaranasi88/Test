 ...
 */
public abstract class ActionBaseTestCase extends XWorkTestCase {
    ...
    private static final com.opensymphony.xwork2.util.logging.Logger LOG = LoggerFactory.getLogger(ActionBaseTestCase.class);
     ...
     */
    protected String executeAction(String uri) throws Exception, UnsupportedEncodingException {
        ...
        if (response.getStatus() != HttpServletResponse.SC_OK) {
            throw new Exception("Error code [" + response.getStatus() + "], Error: [" + response.getErrorMessage() + "]");
        }
